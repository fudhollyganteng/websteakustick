...
<head>
  <meta charset="utf-8" />
  <title>STICKUSTEAK - Our Branch</title>
      ...
      <div class="navbar-nav ms-auto p-4 p-lg-0">
        ...
        <div class="nav-item dropdown">
          ...
          <div class="dropdown-menu m-0">
            ...
            <a href="places.php" class="dropdown-item active">Our branch</a>
  ...
  <div class="container-xxl py-5">
    <div class="container">
      <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px">
        ...
        <h1 class="text-uppercase">Meet Other Places</h1>
      </div>
      <div class="row g-4">
          ...
          <div class="team-item">
            <div class="team-img position-relative overflow-hidden">
              ...
              <div class="team-social">
                <a class="btn btn-square" href="https://www.instagram.com/stickusteak.id/"><i
                    class="fab fa-instagram"></i></a>
                <a class="btn btn-square" href="https://www.facebook.com/StickuSteak/"><i
