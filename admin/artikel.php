...
<body>
    ...
    <div class="container-xxl py-5">
        <div class="container">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-4 col-md-6 wow fadeInUp mb-4" data-wow-delay="0.1s">
                            <div class="service-item position-relative overflow-hidden bg-secondary d-flex h-100 p-5 ps-0">
                                <div class="ps-4">
                                <a href="artikelDetail.php?id=<?= $row['id'];?>"><h3 class="text-uppercase mb-3"><?= $row['judul_art'];?></h3></a>
                                    <p>
                                        <?= $row['sub_artikel'];?>
                                    </p>
                                </div>
                                <a class="btn btn-square" href="editArtikel.php?id=<?= $row['id'];?>">Edit</a>
                            </div>
                            <a class="btn btn-square text-primary" href="hapus.php?id=<?= $row['id'];?>">Hapus</a>
                        </div>
                        <?php endforeach; ?>
                    </div>
                </div>
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px">
                <p class="d-inline-block bg-secondary text-primary py-1 px-4">
                    <a href="tambahArtikel.php">Add +</a>
                </p>
            </div>
            </div>
