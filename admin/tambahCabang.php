                ...
                <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="form-group text-start">
                            ...
                            <textarea class="form-control mt-1" name="alamat" placeholder="Tambahkan data alamat"
                                rows="4"></textarea>
                        </div>

                        <div class="form-group text-start">
                            <label class="mt-4" style="color: #bf9b44;">Deskripsi</label>
                            <textarea class="form-control mt-1" name="deskripsi" placeholder="Tambahkan data cabang"
                                rows="4"></textarea>
                        </div>
                        ...
                        <button type="submit" class="btn btn-outline-primary update" name="insert">ADD +</button>
